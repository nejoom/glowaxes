 ...
 * specification</a> and emit the resulting data to the output stream.
 * 
...
public class Base64Encoder {
    ...
    /**
     * Testing the encoder. Run with one argument, prints the encoded version of
     * it.
     * 
     * @param args the args
     * 
     ...
     * @throws UnsupportedEncodingException the unsupported encoding exception
     */
    public Base64Encoder(String input) throws UnsupportedEncodingException {
        byte bytes[];
    ...
    /**
     * Encode the content of this encoder, as a string. This methods encode the
     * String content, that was provided at creation time, following the BASE64
     * rules, as specified in the rfc1521.
     * 
     * @return A String, reprenting the encoded content of the input String.
     * 
     * @throws IOException Signals that an I/O exception has occurred.
     */
    public byte[] processBytes() throws IOException {
        process();
