...
/**
 * The Class StackedColumn.
 */
public class StackedColumn extends ABarPlotter {

    // Define a static logger variable so that it references the
    // Logger instance named after class.
    /** The logger. */
    private static Logger logger =
            Logger.getLogger(StackedColumn.class.getName());
    ...
    public Element drawValue(Value value) {
        ...
        polygon.setAttribute("desc", "stacked-column");
