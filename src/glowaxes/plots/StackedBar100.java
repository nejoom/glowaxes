...
/**
 * The Class StackedBar100.
 */
public class StackedBar100 extends ABarPlotter {

    // Define a static logger variable so that it references the
    // Logger instance named after class.
    /** The logger. */
    private static Logger logger =
            Logger.getLogger(StackedBar100.class.getName());
    ...
    public Element drawValue(Value value) {
        ...
        polygon.setAttribute("desc", "stacked-bar-100%");
    ...
    public void prepareData() {
        ...
        for (int i = 0; i < plotSet.getSize(); i++) {
            ...
            for (int j = 0; j < mySeries.getSize(); j++) {
                ...
                myValue.setB1(myValue.getX() / length);
