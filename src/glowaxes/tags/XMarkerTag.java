...
/**
 * The Class XMarkerTag.
 */
public class XMarkerTag extends AbstractMarkerTag {

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = 5253189711842388316L;
     ...
     */
    /**
     * Instantiates a new x marker tag.
     */
    public XMarkerTag() {
        super();
    ...
    public int doStartTag() throws JspTagException {
        ...
        if (areaTag == null) {
            throw new JspTagException(
                    "<ga:xmarker> tag must be within a <ga:area> tag");
        } else {
            areaTag.setAttribute("xmarker", markerAttributes);
        }
