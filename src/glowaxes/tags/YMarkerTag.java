...
/**
 * The Class YMarkerTag.
 */
public class YMarkerTag extends AbstractMarkerTag {

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = 624060164933551512L;
     ...
     */
    /**
     * Instantiates a new y marker tag.
     */
    public YMarkerTag() {
        super();
    ...
    public int doStartTag() throws JspTagException {
        ...
        if (areaTag == null) {
            throw new JspTagException(
                    "<ga:ymarker> tag must be within a <ga:area> tag");
        } else {
            areaTag.setAttribute("ymarker", markerAttributes);
        }
