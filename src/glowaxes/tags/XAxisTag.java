 ...
 * The Class XAxisTag.
 */
public class XAxisTag extends AbstractAxisTag {

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = 8128447455318244350L;
    ...
    public int doEndTag() throws JspTagException {
        ...
        if (areaTag == null) {
            throw new JspTagException(
                    "<ga:xaxis> tag must be within a <ga:area> tag");
        } else {
            areaTag.setAttribute("xaxis", axisAttributes);
        }
