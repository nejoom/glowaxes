...
public class RasterizeServlet extends HttpServlet {
    ...
    private static Logger logger =
            Logger.getLogger(RasterizeServlet.class.getName());
    ...
    protected void doGet(HttpServletRequest request,
        ...
        if (url == null)
            throw new RuntimeException("url parameter is not defined (null)");
        else if (url.indexOf("svg") == -1)
            throw new RuntimeException("url parameter not pointing to svg file");
